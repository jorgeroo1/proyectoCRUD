 ...
 */
final class Version20240410173255 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie ADD country_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE movie ADD CONSTRAINT FK_1D5EF26FF92F3E70 FOREIGN KEY (country_id) REFERENCES country (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
...
//        $this->addSql('CREATE SCHEMA public');
        ...
        $this->addSql('DROP INDEX IDX_1D5EF26FF92F3E70');
        $this->addSql('ALTER TABLE movie DROP genre_id');
        $this->addSql('ALTER TABLE movie DROP country_id');
    }
}
